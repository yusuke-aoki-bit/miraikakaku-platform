...
export default function SocialShare({ title, url }: SocialShareProps) {
  ...
  return (
    <div className="bg-surface-elevated rounded-lg border border-border-primary p-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <ShareIcon className="h-5 w-5 text-text-secondary" />
          <span className="text-sm font-medium text-text-primary">この記事をシェア</span>
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-full bg-black hover:bg-black/80 text-white transition-colors"
            title="Xでシェア"
            aria-label="Xでシェア"
          >
