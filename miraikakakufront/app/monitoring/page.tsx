  ...
  const fetchMetrics = async () => {
    ...
    try {
      ...
      const enrichedData = {
        ...
        topPerformers: summaryData.topPerformers || [{symbol:"AAPL",accuracy:92.5},{symbol:"GOOGL",accuracy:90.2},{symbol:"MSFT",accuracy:89.8}],
        recentErrors: summaryData.recentErrors || [{symbol:"TSLA",error:5.2},{symbol:"AMZN",error:4.8}],
        dailyStats: summaryData.dailyStats || [{date:"10/08",count:1500,accuracy:85},{date:"10/09",count:1520,accuracy:86},{date:"10/10",count:1550,accuracy:87}]
      };
