    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto p-4 md:p-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">第11条（個人情報の取扱い）</h2>
            <div className="prose text-gray-700 space-y-4">
              <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">第12条（通知または連絡）</h2>
            <div className="prose text-gray-700 space-y-4">
              <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">第13条（権利義務の譲渡の禁止）</h2>
            <div className="prose text-gray-700 space-y-4">
              <p>
