...
class DataPipelineService:
    ...
    def update_stock_data(self, symbol: str) -> bool:
        ...
        try:
            ...
            for date, row in hist.iterrows():
                existing = self.db_session.query(StockPriceHistory).filter(
    ...
    def seed_sample_stocks(self):
        ...
        sample_stocks = [
            ...
            {'symbol': 'NVDA', 'company_name': 'NVIDIA Corporation', 'exchange': 'NASDAQ', 'sector': 'Technology'},
            {'symbol': 'META', 'company_name': 'Meta Platforms Inc.', 'exchange': 'NASDAQ', 'sector': 'Technology'},
            {'symbol': 'NFLX', 'company_name': 'Netflix Inc.', 'exchange': 'NASDAQ', 'sector': 'Entertainment'},
        ]
        
        for stock_data in sample_stocks:
            existing = self.db_session.query(StockMaster).filter(
