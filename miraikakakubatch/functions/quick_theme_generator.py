...
def generate_massive_theme_insights():
    ...
    themes = [
        ...
        ("量子コンピューティング", "technology", "量子技術のブレークスルーが産業構造を変革"),
        ("メタバース経済", "technology", "仮想空間ビジネスが新たな収益源として急成長"),
        ("サイバーセキュリティ", "technology", "サイバー攻撃の増加により防御技術への需要急増"),
        ("ブロックチェーン", "technology", "分散型技術の実用化が金融・物流セクターを変革"),
        
        # ヘルスケア
        ("個別化医療", "healthcare", "遺伝子解析技術により患者個別の治療法が実現"),
        ("デジタルヘルス", "healthcare", "遠隔医療とヘルスケアアプリが医療アクセスを革新"),
        ...
        ("パーソナライゼーション", "consumer", "AI活用による個別最適化が顧客満足度を向上"),
        ...
        ("エッジコンピューティング", "communication", "分散処理がレイテンシを削減し新サービスを創出"),
    ...
    # 影響を受ける銘柄のプール
    stock_pools = {
        "technology": ["AAPL", "GOOGL", "MSFT", "NVDA", "META", "AMZN", "CRM", "ORCL", "ADBE", "INTC"],
        "healthcare": ["JNJ", "PFE", "UNH", "CVS", "ABBV", "MRK", "TMO", "ABT", "DHR", "AMGN"],
        "energy": ["XOM", "CVX", "COP", "SLB", "EOG", "NEE", "ENPH", "D", "SO", "DUK"],
        "finance": ["JPM", "BAC", "WFC", "GS", "MS", "C", "AXP", "BLK", "SCHW", "COF"],
        "consumer": ["WMT", "AMZN", "HD", "PG", "KO", "PEP", "NKE", "MCD", "SBUX", "TGT"],
        "industrial": ["BA", "CAT", "HON", "UPS", "GE", "MMM", "LMT", "RTX", "DE", "EMR"],
        "realestate": ["AMT", "PLD", "CCI", "EQIX", "PSA", "SPG", "WELL", "AVB", "EQR", "DLR"],
        "transportation": ["TSLA", "GM", "F", "UBER", "DAL", "UAL", "UPS", "FDX", "CSX", "NSC"],
        "communication": ["T", "VZ", "TMUS", "CMCSA", "DIS", "NFLX", "GOOGL", "META", "SNAP", "TWTR"]
    }
        ...
        with db.engine.begin() as conn:
            for theme_name, category, base_driver in themes:
                ...
                for i in range(random.randint(10, 20)):
                    ...
                    key_drivers = ", ".join(random.sample(drivers, random.randint(2, 4)))
