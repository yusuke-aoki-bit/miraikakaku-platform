...
class USStockExpander:
    ...
    def fetch_nasdaq_symbols(self):
        ...
        try:
            ...
            major_nasdaq = [
                ...
                'COST', 'TMUS', 'AVGO', 'TXN', 'QCOM', 'INTU', 'AMD', 'AMAT',
                'ISRG', 'BKNG', 'MU', 'ADI', 'LRCX', 'KLAC', 'MELI', 'REGN',
                'ATVI', 'MDLZ', 'ADP', 'GILD', 'VRTX', 'FISV', 'CSX', 'ADSK',
                'MCHP', 'MRNA', 'FTNT', 'NXPI', 'DXCM', 'BIIB', 'TEAM', 'KDP',
                'CRWD', 'ABNB', 'DOCU', 'ZM', 'PTON', 'ROKU', 'TWLO', 'OKTA'
            ]
            ...
            # ETFの主要銘柄も追加
            major_etfs = [
                'QQQ', 'IWM', 'VTI', 'VOO', 'SPY', 'EEM', 'VEA', 'VWO',
    ...
    def fetch_nyse_symbols(self):
        ...
        major_nyse = [
            'ABBV', 'ACN', 'AIG', 'ALL', 'AMGN', 'AXP', 'BA', 'BAC', 'BRK-B',
            'C', 'CAT', 'CVX', 'DIS', 'DOW', 'GE', 'GM', 'HD', 'IBM', 'JNJ',
            'JPM', 'KO', 'LMT', 'MA', 'MCD', 'MMM', 'MRK', 'NKE', 'PFE', 'PG',
            'T', 'UNH', 'V', 'VZ', 'WMT', 'XOM', 'F', 'GS', 'HON', 'LOW',
            'MS', 'NEE', 'RTX', 'SO', 'UPS', 'WFC', 'ABT', 'BMY', 'CL', 'COST',
            'CVS', 'DD', 'EMR', 'ETN', 'FDX', 'GD', 'ITW', 'JCI', 'LIN', 'LLY',
            'MMC', 'NOC', 'PH', 'PM', 'SBUX', 'TGT', 'TMO', 'UNP', 'USB', 'VLO'
        ]
        
        # 金融・エネルギー・ヘルスケア主要銘柄
        additional_nyse = [
            'BLK', 'CB', 'COF', 'FCX', 'HUM', 'ICE', 'MCK', 'MET', 'PRU', 'PNC',
            'SCHW', 'SPGI', 'TRV', 'AFL', 'AMP', 'AON', 'AZO', 'BDX', 'BIIB',
            'BK', 'CAH', 'CI', 'CME', 'CNC', 'COO', 'COP', 'DHR', 'DUK', 'ECL'
        ]
    ...
    def generate_additional_symbols(self):
        ...
        # テック株
        tech_stocks = [
            'ORCL', 'SNOW', 'PLTR', 'NET', 'DDOG', 'ZS', 'CRWD', 'OKTA',
            'MDB', 'WORK', 'UBER', 'LYFT', 'DASH', 'COIN', 'HOOD', 'SQ'
        ]
        
        # バイオテック
        biotech_stocks = [
            'AMGN', 'BIIB', 'CELG', 'GILD', 'ILMN', 'INCY', 'REGN', 'VRTX',
            'BMRN', 'EXAS', 'SGEN', 'TECB', 'BLUE', 'SAGE', 'IONS', 'ARWR'
        ]
        
        # 消費財・小売
        consumer_stocks = [
            'AMZN', 'COST', 'HD', 'LOW', 'NKE', 'SBUX', 'TGT', 'WMT',
            'ETSY', 'SHOP', 'EBAY', 'BABA', 'JD', 'PDD', 'SE', 'MELI'
        ]
        
        # 金融・フィンテック
        fintech_stocks = [
            'V', 'MA', 'PYPL', 'SQ', 'ADYEY', 'AFRM', 'LC', 'UPST',
            'SOFI', 'OPEN', 'RBLX', 'U', 'TWTR', 'SNAP', 'PINS', 'MTCH'
        ]
    ...
    def execute_expansion(self):
        ...
        for batch_num in range(total_batches):
            ...
            logger.info(f"バッチ {batch_num + 1}/{total_batches}: {len(batch_symbols)}銘柄処理中")
