...
def generate_theme_insights_correct_schema():
    ...
    themes_data = [
        ...
        (
            ...
            "technology",
            "AIの商業化が急速に進展",
            "人工知能技術の実用化が様々な産業で加速している。機械学習、自然言語処理、コンピュータビジョンの技術進歩により、企業の自動化とデジタル変革が促進されている。",
        ),
        (
            "量子コンピューティング",
            "technology",
            "量子技術の実用化が近づく",
            "量子コンピューティング分野で技術的ブレークスルーが続いている。IBMやGoogleなどの大手企業が量子優位性の実証に成功し、実用的な量子アルゴリズムの開発が進んでいる。",
        ),
        (
            "5G普及加速",
            "technology",
            "5G網の本格展開開始",
            "第5世代移動通信システムの商用展開が世界各地で本格化している。超高速・低遅延通信により、IoT、自動運転、AR/VRなどの新サービスが実現可能になっている。",
        ),
        # Energy
        (
            "脱炭素投資急増",
            "energy",
            "クリーンエネルギーへの資金流入",
            "世界的な脱炭素政策により、再生可能エネルギーとクリーン技術への投資が急速に拡大している。太陽光、風力、水素技術が投資の中心となっている。",
        ),
        (
            "EV革命本格化",
            "energy",
            "電気自動車の普及が加速",
            "電気自動車市場が急速に拡大している。バッテリー技術の向上とコスト低下により、EVの価格競争力が向上し、世界各国でEV普及政策が推進されている。",
        ),
        # Finance
        (
            "DeFi成長継続",
            "finance",
            "分散型金融の急速な発展",
            "分散型金融（DeFi）プロトコルが成熟し、従来の金融サービスを代替する新しいエコシステムが形成されている。流動性マイニング、ステーキング、DEXが主要な成長分野。",
        ),
        (
            "CBDC開発加速",
            "finance",
            "中央銀行デジタル通貨の実用化",
            "世界各国の中央銀行がデジタル通貨の開発を加速している。中国のデジタル人民元をはじめ、欧州、米国でもCBDCの研究開発が本格化している。",
        ),
        # Healthcare
        (
            "個別化医療進展",
            "healthcare",
            "精密医療技術の実用化",
            "ゲノム解析技術の進歩により、患者個人の遺伝情報に基づく個別化医療が実用段階に入っている。がん治療、希少疾患治療で画期的な成果を上げている。",
        ),
        (
            "デジタルヘルス拡大",
            "healthcare",
            "遠隔医療とヘルステック成長",
            "COVID-19を契機に遠隔医療が普及し、ヘルステック市場が急成長している。ウェアラブルデバイス、AI診断、デジタル治療薬が主要な成長分野となっている。",
        ),
        # Consumer
        (
            "D2C市場拡大",
            "consumer",
            "直販モデルの普及加速",
            "従来の小売流通を経由しない直販（D2C）モデルが急速に普及している。SNSマーケティング、サブスクリプションサービスと組み合わせた新しいビジネスモデルが成功している。",
        ),
        # Industrial
        (
            "工場自動化進展",
            "industrial",
            "Industry 4.0の本格導入",
            "製造業でデジタル化とロボット化が急速に進んでいる。IoT、AI、ロボティクスを活用したスマートファクトリーが競争力の源泉となっている。",
        ),
    ]
            ...
            for theme_name, category, title, summary in themes_data:
                ...
                for i in range(20):
                    ...
                    trend_direction = random.choice(
                        ["bullish", "bullish", "neutral", "bearish"]
                    )  # bullish寄り
...
if __name__ == "__main__":
    ...
    with db.engine.connect() as conn:
        total_themes = conn.execute(
            text("SELECT COUNT(*) FROM theme_insights")
        ).scalar()
