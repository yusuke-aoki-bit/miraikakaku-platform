...
def instant_mega_boost():
    ...
    core_symbols = [
        ...
        'JPM', 'BAC', 'V', 'MA', 'WMT', 'HD', 'PG', 'JNJ', 'KO', 'DIS',
        'SPY', 'QQQ', 'IWM', 'VTI', 'GLD', 'XLK', 'XLF', 'XLE',
        '^GSPC', '^DJI', '^IXIC', '^RUT',
        '7203.T', '9984.T', '8306.T', '9983.T', '6098.T'
    ]
    ...
    try:
        ...
        logger.info(f"📊 総追加データ: {total_price_records + total_prediction_records:,}件")
