            ...
            for pred in predictions_data:
                ...
                if predicted_prices:
                    self.db.execute(insert_query, {
                        ...
                        'prediction_range_low': min(pred.get('prediction_range', {}).get('low', [])),
                        'prediction_range_high': max(pred.get('prediction_range', {}).get('high', [])),
    ...
    def insert_analysis_report(self, report_data: Dict[str, Any]) -> int:
        ...
        try:
            ...
            result = self.db.execute(insert_query, {
                ...
                'symbols_analyzed': json.dumps(report_data.get('symbols_analyzed', [])),
